...
function add_css() {
	...
	style.id = "svelte-1wi4co5-style";
	style.textContent = ".container.svelte-1wi4co5.svelte-1wi4co5{--color-background-heading:transparent;--color-background-day:transparent;--color-background-day-empty:var(--background-secondary-alt);--color-background-day-active:var(--interactive-accent);--color-background-day-hover:var(--interactive-hover);--color-dot:var(--text-muted);--color-arrow:currentColor;--color-text-title:var(--text-normal);--color-text-heading:var(--text-normal);--color-text-day:var(--text-normal);--color-text-today:var(--text-accent)}.container.svelte-1wi4co5.svelte-1wi4co5{overflow-y:auto;margin-bottom:24px;padding:0 16px}th.svelte-1wi4co5.svelte-1wi4co5,td.svelte-1wi4co5.svelte-1wi4co5{text-align:center}.title.svelte-1wi4co5.svelte-1wi4co5{color:var(--color-text-title);margin-right:4px;text-align:center}.today.svelte-1wi4co5.svelte-1wi4co5{color:var(--color-text-today)}.active.svelte-1wi4co5.svelte-1wi4co5{background-color:var(--color-background-day-active)}.table.svelte-1wi4co5.svelte-1wi4co5{border-collapse:collapse;width:100%}th.svelte-1wi4co5.svelte-1wi4co5{background-color:var(--color-background-heading);color:var(--color-text-heading);font-size:0.6rem;letter-spacing:1px;padding:4px 8px;text-transform:uppercase}td.svelte-1wi4co5.svelte-1wi4co5{transition:background-color 0.1s ease-in;background-color:var(--color-background-day);color:var(--color-text-day);cursor:pointer;font-size:0.8em;padding:8px}td.svelte-1wi4co5.svelte-1wi4co5:empty{background-color:var(--color-background-day-empty)}td.svelte-1wi4co5.svelte-1wi4co5:not(:empty):hover{background-color:var(--color-background-day-hover)}.dot-container.svelte-1wi4co5.svelte-1wi4co5{height:6px;line-height:6px}.dot.svelte-1wi4co5.svelte-1wi4co5{display:inline-block;fill:var(--color-dot);height:6px;width:6px;margin-right:2px}.dot.svelte-1wi4co5.svelte-1wi4co5:last-of-type{margin-right:0}.ml-2.svelte-1wi4co5.svelte-1wi4co5{margin-left:8px}.mr-2.svelte-1wi4co5.svelte-1wi4co5{margin-right:8px}.arrow.svelte-1wi4co5.svelte-1wi4co5{cursor:pointer;display:inline-block}.arrow.svelte-1wi4co5 svg.svelte-1wi4co5{fill:var(--color-arrow);height:16px;width:16px}";
...
// (220:8) {#each daysOfWeek as dayOfWeek}
...
function create_else_block(ctx) {
	...
	return {
		c() {
			...
			attr(div, "class", "dot-container svelte-1wi4co5");
			attr(td, "class", "svelte-1wi4co5");
...
// (241:18) {#each Array(numDots) as _}
function create_each_block_2(ctx) {
	...
	return {
		c() {
			...
			attr(circle, "cy", "3");
			attr(circle, "r", "2");
			attr(svg, "class", "dot svelte-1wi4co5");
...
// (228:10) {#each week as { dayOfMonth, date, formattedDate, numDots }}
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			h2 = element("h2");
			div0 = element("div");
			div0.innerHTML = `<svg class="arrow svelte-1wi4co5" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path fill="currentColor" d="M34.52 239.03L228.87 44.69c9.37-9.37 24.57-9.37 33.94 0l22.67 22.67c9.36 9.36 9.37 24.52.04 33.9L131.49 256l154.02 154.75c9.34 9.38 9.32 24.54-.04 33.9l-22.67 22.67c-9.37 9.37-24.57 9.37-33.94 0L34.52 272.97c-9.37-9.37-9.37-24.57 0-33.94z"></path></svg>`;
			t0 = space();
			span = element("span");
			t1 = text(/*monthName*/ ctx[3]);
			t2 = space();
			div1 = element("div");
			div1.innerHTML = `<svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" class="svelte-1wi4co5"><path fill="currentColor" d="M285.476 272.971L91.132 467.314c-9.373 9.373-24.569 9.373-33.941 0l-22.667-22.667c-9.357-9.357-9.375-24.522-.04-33.901L188.505 256 34.484 101.255c-9.335-9.379-9.317-24.544.04-33.901l22.667-22.667c9.373-9.373 24.569-9.373 33.941 0L285.475 239.03c9.373 9.372 9.373 24.568.001 33.941z"></path></svg>`;
			t3 = space();
			table = element("table");
			thead = element("thead");
			tr = element("tr");
			...
			attr(div0, "class", "arrow mr-2 svelte-1wi4co5");
			attr(div0, "aria-label", "Previous Month");
			attr(div1, "class", "arrow ml-2 svelte-1wi4co5");
			attr(div1, "aria-label", "Next Month");
			attr(h2, "class", "title svelte-1wi4co5");
			attr(table, "class", "table svelte-1wi4co5");
			attr(div2, "id", "calendar-container");
			attr(div2, "class", "container svelte-1wi4co5");
		},
		m(target, anchor) {
		...
		if ($$self.$$.dirty & /*displayedMonth, settings, month, vault*/ 5636) {
			 {
				...
				for (let weekNum = 0; weekNum <= 5; weekNum++) {
					...
					for (let weekday = 1; weekday <= 7; weekday++) {
						...
						const fileForDay = vault.getAbstractFileByPath(normalizedJoin(getNoteFolder(settings), `${formattedDate}.md`));
...
class Calendar extends SvelteComponent {
	constructor(options) {
		super();
		if (!document.getElementById("svelte-1wi4co5-style")) add_css();
