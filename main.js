...
class CalendarSettingsTab extends obsidian.PluginSettingTab {
    ...
    useDailyNoteSettings() {
        new obsidian.Setting(this.containerEl)
            ...
            .setDesc("Disable if you want to use custom settings that vary from your Daily Note configuration.")
            .addToggle((toggle) => {
    ...
    customNoteSettings() {
        ...
        new obsidian.Setting(this.containerEl).setName("Date Format").addText((toggle) => {
...
function add_css() {
	...
	style.id = "svelte-1s55h6q-style";
	style.textContent = ".container.svelte-1s55h6q.svelte-1s55h6q{--color-background-heading:transparent;--color-background-day:transparent;--color-background-day-empty:var(--background-secondary-alt);--color-background-day-active:var(--interactive-accent);--color-background-day-hover:var(--interactive-hover);--color-dot:var(--text-muted);--color-arrow:currentColor;--color-text-title:var(--text-normal);--color-text-heading:var(--text-normal);--color-text-day:var(--text-normal);--color-text-today:var(--text-accent)}.container.svelte-1s55h6q.svelte-1s55h6q{overflow-y:scroll;padding:0 16px}th.svelte-1s55h6q.svelte-1s55h6q,td.svelte-1s55h6q.svelte-1s55h6q{text-align:center}.title.svelte-1s55h6q.svelte-1s55h6q{color:var(--color-text-title);margin-right:4px;text-align:center}.today.svelte-1s55h6q.svelte-1s55h6q{color:var(--color-text-today)}.active.svelte-1s55h6q.svelte-1s55h6q{background-color:var(--color-background-day-active)}.table.svelte-1s55h6q.svelte-1s55h6q{border-collapse:collapse;width:100%}th.svelte-1s55h6q.svelte-1s55h6q{background-color:var(--color-background-heading);color:var(--color-text-heading);font-size:0.6rem;letter-spacing:1px;padding:4px 8px;text-transform:uppercase}td.svelte-1s55h6q.svelte-1s55h6q{transition:background-color 0.1s ease-in;cursor:pointer;background-color:var(--color-background-day);color:var(--color-text-day);font-size:0.8em;padding:8px}td.svelte-1s55h6q.svelte-1s55h6q:empty{background-color:var(--color-background-day-empty)}td.svelte-1s55h6q.svelte-1s55h6q:not(:empty):hover{background-color:var(--color-background-day-hover)}.dot-container.svelte-1s55h6q.svelte-1s55h6q{height:6px;line-height:6px}.dot.svelte-1s55h6q.svelte-1s55h6q{display:inline-block;fill:var(--color-dot);height:6px;width:6px;margin-right:2px}.dot.svelte-1s55h6q.svelte-1s55h6q:last-of-type{margin-right:0}.ml-2.svelte-1s55h6q.svelte-1s55h6q{margin-left:8px}.mr-2.svelte-1s55h6q.svelte-1s55h6q{margin-right:8px}.arrow.svelte-1s55h6q.svelte-1s55h6q{cursor:pointer;display:inline-block}.arrow.svelte-1s55h6q svg.svelte-1s55h6q{fill:var(--color-arrow);height:16px;width:16px}";
...
// (222:8) {#each daysOfWeek as dayOfWeek}
...
function create_else_block(ctx) {
	...
	return {
		c() {
			...
			attr(div, "class", "dot-container svelte-1s55h6q");
			attr(td, "class", "svelte-1s55h6q");
...
// (243:18) {#each Array(numDots) as _}
function create_each_block_2(ctx) {
	...
	return {
		c() {
			...
			attr(circle, "cy", "3");
			attr(circle, "r", "2");
			attr(svg, "class", "dot svelte-1s55h6q");
...
// (230:10) {#each week as { dayOfMonth, date, formattedDate, numDots }}
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			h2 = element("h2");
			div0 = element("div");
			div0.innerHTML = `<svg class="arrow svelte-1s55h6q" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><path fill="currentColor" d="M34.52 239.03L228.87 44.69c9.37-9.37 24.57-9.37 33.94 0l22.67 22.67c9.36 9.36 9.37 24.52.04 33.9L131.49 256l154.02 154.75c9.34 9.38 9.32 24.54-.04 33.9l-22.67 22.67c-9.37 9.37-24.57 9.37-33.94 0L34.52 272.97c-9.37-9.37-9.37-24.57 0-33.94z"></path></svg>`;
			t0 = space();
			span = element("span");
			...
			attr(div0, "class", "arrow mr-2 svelte-1s55h6q");
			attr(div0, "aria-label", "Previous Month");
			attr(div1, "class", "arrow ml-2 svelte-1s55h6q");
			attr(div1, "aria-label", "Next Month");
			attr(h2, "class", "title svelte-1s55h6q");
			attr(table, "class", "table svelte-1s55h6q");
			attr(div2, "id", "calendar-container");
			attr(div2, "class", "container svelte-1s55h6q");
		},
		m(target, anchor) {
		...
		if ($$self.$$.dirty & /*displayedMonth, settings, month, vault*/ 5636) {
			 {
				...
				if (settings.shouldStartWeekOnMonday) {
					...
					$$invalidate(4, daysOfWeek = [...restOfWeek, sunday]);
				}
				...
				for (let weekNum = 0; weekNum <= 5; weekNum++) {
					...
					for (let weekday = 1; weekday <= 7; weekday++) {
						...
						const fileForDay = vault.getAbstractFileByPath(normalizedJoin(getNoteFolder(settings), baseFilename));
...
class Calendar extends SvelteComponent {
	constructor(options) {
		super();
		if (!document.getElementById("svelte-1s55h6q-style")) add_css();
