...
function getDailyNote(date) {
    ...
    var formattedDate = date.format(dailyNoteSettings.format);
    var dailyNotePath = getNotePath(dailyNoteSettings.folder, formattedDate);
    return vault.getAbstractFileByPath(dailyNotePath);
}
...
function getMonthData(activeFile, displayedMonth, settings) {
    ...
    for (let weekNum = 0; weekNum <= 5; weekNum++) {
        ...
        for (let weekday = 0; weekday < 7; weekday++) {
            ...
            const fileForDay = main.getDailyNote(date);
            week.push({
                date,
                dayOfMonth,
                isActive: activeFile && activeFile === (fileForDay === null || fileForDay === void 0 ? void 0 : fileForDay.basename),
                numDots: getNumberOfDots(fileForDay, settings),
                numTasksRemaining: getNumberOfRemainingTasks(fileForDay),
                notePath: fileForDay === null || fileForDay === void 0 ? void 0 : fileForDay.path,
            });
            dayOfMonth++;
        }
...
function add_css() {
	...
	style.id = "svelte-7sxnz0-style";
	style.textContent = ".day.svelte-7sxnz0.svelte-7sxnz0{border-radius:4px;height:100%;text-align:center;vertical-align:baseline}.today.svelte-7sxnz0.svelte-7sxnz0{color:var(--color-text-today)}.active.svelte-7sxnz0.svelte-7sxnz0,.active.today.svelte-7sxnz0.svelte-7sxnz0{color:var(--text-on-accent);background-color:var(--interactive-accent)}.day.svelte-7sxnz0.svelte-7sxnz0{transition:background-color 0.1s ease-in, color 0.1s ease-in;background-color:var(--color-background-day);color:var(--color-text-day);cursor:pointer;font-size:0.8em;padding:8px}.day.svelte-7sxnz0.svelte-7sxnz0:not(:empty):hover{background-color:var(--interactive-hover)}.day.active.svelte-7sxnz0.svelte-7sxnz0:hover{background-color:var(--interactive-accent-hover)}.dot-container.svelte-7sxnz0.svelte-7sxnz0{display:flex;flex-wrap:wrap;justify-content:center;line-height:6px;min-height:6px}.dot.svelte-7sxnz0.svelte-7sxnz0,.task.svelte-7sxnz0.svelte-7sxnz0{display:inline-block;fill:var(--color-dot);height:6px;width:6px;margin:0 1px}.active.svelte-7sxnz0 .dot.svelte-7sxnz0{fill:var(--text-on-accent)}.task.svelte-7sxnz0.svelte-7sxnz0{fill:none;stroke:var(--color-dot)}.active.svelte-7sxnz0 .task.svelte-7sxnz0{stroke:var(--text-on-accent)}";
...
function create_each_block(ctx) {
	...
	return {
		c() {
			...
			attr(circle, "cy", "3");
			attr(circle, "r", "2");
			attr(svg, "class", "dot svelte-7sxnz0");
...
function create_if_block(ctx) {
	...
	return {
		c() {
			...
			attr(circle, "cy", "3");
			attr(circle, "r", "2");
			attr(svg, "class", "task svelte-7sxnz0");
			attr(svg, "viewBox", "0 0 6 6");
			attr(svg, "xmlns", "http://www.w3.org/2000/svg");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	handle_promise(promise = /*numDots*/ ctx[7], info);
	...
	handle_promise(promise_1 = /*numTasksRemaining*/ ctx[6], info_1);
	...
	return {
		c() {
			...
			t2 = space();
			info_1.block.c();
			attr(div0, "class", "dot-container svelte-7sxnz0");
			attr(div1, "class", "day svelte-7sxnz0");
			toggle_class(div1, "active", /*isActive*/ ctx[3]);
			toggle_class(div1, "today", /*date*/ ctx[5].isSame(/*today*/ ctx[2]));
		},
		m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	let { day } = $$props;
	let { today } = $$props;
	const { isActive, dayOfMonth, date, numTasksRemaining, numDots, notePath } = day;
	...
	$$self.$$set = $$props => {
		...
		if ("day" in $$props) $$invalidate(9, day = $$props.day);
...
class Day extends SvelteComponent {
	constructor(options) {
		super();
		if (!document.getElementById("svelte-7sxnz0-style")) add_css();
...
function add_css$1() {
	var style = element("style");
	style.id = "svelte-1dw3bc-style";
	style.textContent = ".container.svelte-1dw3bc.svelte-1dw3bc{--color-background-heading:transparent;--color-background-day:transparent;--color-background-weeknum:transparent;--color-background-weekend:transparent;--color-dot:var(--text-muted);--color-arrow:var(--text-muted);--color-button:var(--text-muted);--color-text-title:var(--text-normal);--color-text-heading:var(--text-muted);--color-text-day:var(--text-normal);--color-text-today:var(--interactive-accent);--color-text-weeknum:var(--text-muted)}.container.svelte-1dw3bc.svelte-1dw3bc{padding:0 8px}th.svelte-1dw3bc.svelte-1dw3bc,td.svelte-1dw3bc.svelte-1dw3bc{border-radius:4px;height:100%;text-align:center;vertical-align:baseline}.nav.svelte-1dw3bc.svelte-1dw3bc{align-items:center;display:flex;margin:0.6em 0 1em;padding:0 8px;width:100%}.title.svelte-1dw3bc.svelte-1dw3bc{color:var(--color-text-title);font-size:1.5em;margin:0}.month.svelte-1dw3bc.svelte-1dw3bc{font-weight:500;text-transform:capitalize}.year.svelte-1dw3bc.svelte-1dw3bc{color:var(--interactive-accent)}.right-nav.svelte-1dw3bc.svelte-1dw3bc{display:flex;justify-content:center;margin-left:auto}.reset-button.svelte-1dw3bc.svelte-1dw3bc{border-radius:4px;color:var(--text-muted);font-size:0.7em;font-weight:600;letter-spacing:1px;margin:0 4px;padding:0px 4px;text-transform:uppercase}.week-num.svelte-1dw3bc.svelte-1dw3bc{background-color:var(--color-background-day);background-color:var(--color-background-weeknum);border-right:1px solid var(--background-modifier-border);color:var(--color-text-weeknum);cursor:pointer;font-size:0.65em;padding:0;padding:8px}.week-num.svelte-1dw3bc.svelte-1dw3bc:hover{background-color:var(--interactive-hover)}.weekend.svelte-1dw3bc.svelte-1dw3bc{background-color:var(--color-background-weekend)}.calendar.svelte-1dw3bc.svelte-1dw3bc{border-collapse:collapse;width:100%}th.svelte-1dw3bc.svelte-1dw3bc{background-color:var(--color-background-heading);color:var(--color-text-heading);font-size:0.6rem;letter-spacing:1px;padding:4px 8px;text-transform:uppercase}.arrow.svelte-1dw3bc.svelte-1dw3bc{align-items:center;cursor:pointer;display:flex;justify-content:center;width:24px}.arrow.svelte-1dw3bc svg.svelte-1dw3bc{color:var(--color-arrow);height:16px;width:16px}";
	append(document.head, style);
}
...
// (199:6) {#if settings.showWeeklyNote}
...
function create_each_block_3(ctx) {
	...
	return {
		c() {
			col = element("col");
			attr(col, "class", "svelte-1dw3bc");
			toggle_class(col, "weekend", isWeekend(/*day*/ ctx[20].date));
		},
		m(target, anchor) {
			insert(target, col, anchor);
		},
		p(ctx, dirty) {
			if (dirty & /*isWeekend, month*/ 16) {
				toggle_class(col, "weekend", isWeekend(/*day*/ ctx[20].date));
			}
		},
		d(detaching) {
...
// (208:8) {#if settings.showWeeklyNote}
...
// (211:8) {#each daysOfWeek as dayOfWeek}
function create_each_block_2(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*daysOfWeek*/ 32 && t_value !== (t_value = /*dayOfWeek*/ ctx[23] + "")) set_data(t, t_value);
		},
		d(detaching) {
			if (detaching) detach(th);
		}
...
// (219:10) {#if settings.showWeeklyNote}
function create_if_block_1(ctx) {
	...
	return {
		c() {
			td = element("td");
			t = text(t_value);
			attr(td, "class", "week-num svelte-1dw3bc");
		},
		m(target, anchor) {
			insert(target, td, anchor);
			append(td, t);
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			if (dirty & /*month*/ 16 && t_value !== (t_value = getWeekNumber(/*week*/ ctx[17]) + "")) set_data(t, t_value);
		},
		d(detaching) {
			if (detaching) detach(td);
			mounted = false;
...
function create_else_block(ctx) {
	...
	day = new Day({
			props: {
				day: /*day*/ ctx[20],
				onHover: /*onHover*/ ctx[1],
				openOrCreateDailyNote: /*openOrCreateDailyNote*/ ctx[2],
				today: /*today*/ ctx[6]
			}
		});
	...
	return {
		...
		p(ctx, dirty) {
			const day_changes = {};
			if (dirty & /*month*/ 16) day_changes.day = /*day*/ ctx[20];
			if (dirty & /*onHover*/ 2) day_changes.onHover = /*onHover*/ ctx[1];
			if (dirty & /*openOrCreateDailyNote*/ 4) day_changes.openOrCreateDailyNote = /*openOrCreateDailyNote*/ ctx[2];
			if (dirty & /*today*/ 64) day_changes.today = /*today*/ ctx[6];
			day.$set(day_changes);
		},
		i(local) {
			if (current) return;
...
function create_each_block$1(ctx) {
	...
	let t1;
	let current;
	let if_block = /*settings*/ ctx[7].showWeeklyNote && create_if_block_1(ctx);
	...
	return {
		...
		p(ctx, dirty) {
			if (/*settings*/ ctx[7].showWeeklyNote) {
				if (if_block) {
					if_block.p(ctx, dirty);
				} else {
			...
			if (dirty & /*month, onHover, openOrCreateDailyNote, today*/ 86) {
...
function create_fragment$1(ctx) {
	...
	let mounted;
	let dispose;
	let if_block0 = /*settings*/ ctx[7].showWeeklyNote && create_if_block_3();
	let each_value_3 = /*month*/ ctx[4][1];
	let each_blocks_2 = [];
	...
	let if_block1 = /*settings*/ ctx[7].showWeeklyNote && create_if_block_2();
	let each_value_2 = /*daysOfWeek*/ ctx[5];
	let each_blocks_1 = [];
	...
	return {
		c() {
			...
			div3 = element("div");
			div0 = element("div");
			div0.innerHTML = `<svg focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" class="svelte-1dw3bc"><path fill="currentColor" d="M34.52 239.03L228.87 44.69c9.37-9.37 24.57-9.37 33.94 0l22.67 22.67c9.36 9.36 9.37 24.52.04 33.9L131.49 256l154.02 154.75c9.34 9.38 9.32 24.54-.04 33.9l-22.67 22.67c-9.37 9.37-24.57 9.37-33.94 0L34.52 272.97c-9.37-9.37-9.37-24.57 0-33.94z"></path></svg>`;
			t4 = space();
			div1 = element("div");
			div1.textContent = `${/*todayDisplayStr*/ ctx[8]}`;
			t6 = space();
			div2 = element("div");
			div2.innerHTML = `<svg role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" class="svelte-1dw3bc"><path fill="currentColor" d="M285.476 272.971L91.132 467.314c-9.373 9.373-24.569 9.373-33.941 0l-22.667-22.667c-9.357-9.357-9.375-24.522-.04-33.901L188.505 256 34.484 101.255c-9.335-9.379-9.317-24.544.04-33.901l22.667-22.667c9.373-9.373 24.569-9.373 33.941 0L285.475 239.03c9.373 9.372 9.373 24.568.001 33.941z"></path></svg>`;
			t7 = space();
			table = element("table");
			...
			attr(span0, "class", "month svelte-1dw3bc");
			attr(span1, "class", "year svelte-1dw3bc");
			attr(h3, "class", "title svelte-1dw3bc");
			attr(div0, "class", "arrow svelte-1dw3bc");
			attr(div0, "aria-label", "Previous Month");
			attr(div1, "class", "reset-button svelte-1dw3bc");
			attr(div2, "class", "arrow svelte-1dw3bc");
			attr(div2, "aria-label", "Next Month");
			attr(div3, "class", "right-nav svelte-1dw3bc");
			attr(div4, "class", "nav svelte-1dw3bc");
			attr(table, "class", "calendar svelte-1dw3bc");
			attr(div5, "id", "calendar-container");
			attr(div5, "class", "container svelte-1dw3bc");
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*daysOfWeek*/ 32) {
				each_value_2 = /*daysOfWeek*/ ctx[5];
				let i;
			...
			if (dirty & /*month, onHover, openOrCreateDailyNote, today, openOrCreateWeeklyNote, isMetaPressed, getWeekNumber, settings*/ 222) {
				each_value = /*month*/ ctx[4];
				let i;
...
function instance$1($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		if ("activeFile" in $$props) $$invalidate(12, activeFile = $$props.activeFile);
		...
		if ("openOrCreateWeeklyNote" in $$props) $$invalidate(3, openOrCreateWeeklyNote = $$props.openOrCreateWeeklyNote);
	};

	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*settings, activeFile, displayedMonth*/ 4225) {
			 {
				$$invalidate(5, daysOfWeek = getDaysOfWeek());
				$$invalidate(4, month = getMonthData(activeFile, displayedMonth, settings));
			}
		}
	};
...
class Calendar extends SvelteComponent {
	constructor(options) {
		super();
		if (!document.getElementById("svelte-1dw3bc-style")) add_css$1();
...
class CalendarView extends obsidian.ItemView {
    ...
    async _openOrCreateDailyNote(date, inNewSplit) {
        const { workspace } = this.app;
        const fileObj = main.getDailyNote(date);
        if (!fileObj) {
            // File doesn't exist
